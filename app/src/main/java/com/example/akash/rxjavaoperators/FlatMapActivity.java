...
/*FlatMap - Here, we are trying to add address to user object. We have two observable here, 1. Observable with user without address
* 2. Observable with user with address
* Note: Order is not maintained*/

public class FlatMapActivity extends AppCompatActivity {

    private Disposable disposable;
    public static final String TAG = FlatMapActivity.class.getSimpleName();
